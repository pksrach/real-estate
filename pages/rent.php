      ...
      <div class="row">
        <div class="col-md-6 col-lg-4">
          <div class="property-entry">
            ...
            <div class="property-specs">
              <strong class="price d-inline-block">$1,900</strong>/month
        ...
        <div class="col-md-6 col-lg-4">
          <div class="property-entry">
            ...
            <div class="property-specs">
              <strong class="price d-inline-block">$900</strong>/month
              <ul class="list-unstyled specs">
                <li class="d-inline-flex align-items-center">
                  <span class="icon-wrap flaticon-bathtub"></span>
                  <strong>2</strong>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="property-entry">
            ...
            <div class="property-specs">
              <strong class="price d-inline-block">$500</strong>/month
              <ul class="list-unstyled specs">
                <li class="d-inline-flex align-items-center">
                  <span class="icon-wrap flaticon-bathtub"></span>
                  <strong>2</strong>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="property-entry">
            <img src="images/property_3-min.jpg" alt="Image" class="img-fluid">
            <div class="property-specs">
              <strong class="price d-inline-block">$350</strong>/month
              <ul class="list-unstyled specs">
                <li class="d-inline-flex align-items-center">
                  <span class="icon-wrap flaticon-bathtub"></span>
                  <strong>2</strong>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="property-entry">
            <img src="images/property_1-min.jpg" alt="Image" class="img-fluid">
            <div class="property-specs">
              <strong class="price d-inline-block">$800</strong>/month
              <ul class="list-unstyled specs">
                <li class="d-inline-flex align-items-center">
                  <span class="icon-wrap flaticon-bathtub"></span>
                  <strong>2</strong>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="property-entry">
            <img src="images/property_3-min.jpg" alt="Image" class="img-fluid">
            <div class="property-specs">
              <strong class="price d-inline-block">$300</strong>/month
              <ul class="list-unstyled specs">
                <li class="d-inline-flex align-items-center">
                  <span class="icon-wrap flaticon-bathtub"></span>
                  <strong>2</strong>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="property-entry">
            <img src="images/property_2-min.jpg" alt="Image" class="img-fluid">
            <div class="property-specs">
              <strong class="price d-inline-block">$1,000</strong>/month
              <ul class="list-unstyled specs">
                <li class="d-inline-flex align-items-center">
                  <span class="icon-wrap flaticon-bathtub"></span>
                  <strong>2</strong>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="property-entry">
            <img src="images/property_3-min.jpg" alt="Image" class="img-fluid">
            <div class="property-specs">
              <strong class="price d-inline-block">$1,500</strong>/month
              <ul class="list-unstyled specs">
                <li class="d-inline-flex align-items-center">
                  <span class="icon-wrap flaticon-bathtub"></span>
                  <strong>2</strong>
